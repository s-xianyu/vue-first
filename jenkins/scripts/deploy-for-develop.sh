...
echo 'Now...'
echo 'Visit http://192.168.20.93:8989 to see your Node.js/React application in action.'
echo '(This is why you specified the "args ''-p 8989:8080''" parameter when you'
